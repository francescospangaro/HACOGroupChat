...
def applicationName = "HACOGroupChat"
def optsEnvironmentVar = "HACO_OPTS"
def defaultJvmOpts = ""
def distributions = [
        [name: "temurin21Linux", distribution: "temurin", platform: "linux-x86_64", version: "21.0.3", archiveType: "tar.gz"],
        [name: "temurin21Windows", distribution: "temurin", platform: "windows-x86_64", version: "21.0.3", archiveType: "zip"],
        [name: "temurin21OsxArm64", distribution: "temurin", platform: "osx-arm64", version: "21.0.3", archiveType: "tar.gz"],
]
def launchers = [
        [name: "peer", mainClass: "it.polimi.peer.AppMain", winNoConsole: true],
        [name: "peer-console", mainClass: "it.polimi.peer.AppMain", winNoConsole: false],
        [name: "discovery", mainClass: "it.polimi.discovery.MainServer", winNoConsole: false],
]
